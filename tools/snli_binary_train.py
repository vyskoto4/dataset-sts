...
Usage: tools/snli_binary_train.py MODEL TRAINDATA VALDATA [PARAM=VALUE]...

Example: tools/snli_binary_train.py cnn data/para/msr/msr-para-train.tsv data/para/msr/msr-para-val.tsv inp_e_dropout=1/2
